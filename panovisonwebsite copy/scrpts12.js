...
function randomColor() {
  ...
  var boxes = [];
  var words = ["Two", "parts", "of", "the", "city", "merge", "together" ,"." , "Both", "very", "different", "one" ,"is" ,"the", "city", "buildings", "in", "contrast", "the", "other", "one", "is", "a","trail" ,".", "However",",", "they", "both", "curve", "in", "the", "same", "way", "making", "it", "cohesive","."];
