...
function randomColor() {
  ...
  var boxes = [];
  var words = ["As", "I", "looked", "warped", "I'm", "suddenly", "two", "faced","." ,"Two", "faces", "as", "in", "there's", "multiple", "parts", "of", "Who", "I", "am", ".", "This", "sounds", "so", "deep", "but", "true", "though",".", "In", "both", "photos", "I", "have", "my", "beats", "on", "they", "connect", "me", "and", "the", "world", "we", "live", "in"];
