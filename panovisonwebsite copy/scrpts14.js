...
function randomColor() {
  ...
  var boxes = [];
  var words = ["Everyday","where","I","go","it's","the","same",",","everyday","feels","robotic",".","I","cant","tell", "why", "my", "actions", "all", "feel", "the", "same", "."," Hallways", "and", "classes", "all" ,"feel", "the", "same", "."," I'm","just", "going", "to", "class", "for", "my", "education", "but", "it", "all" ,"feels" ,"the","same"," ....."];
