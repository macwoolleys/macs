...
function randomColor() {
  ...
  var boxes = [];
  var words = ["Distorted", "face", "shifts", "into", "another.", "Various", "lines", "begin", "to", "intersect.", "Negative", "white", "space", "fills", "these", "areas", "and", "I'm", "wondering", "in", "them—", "where", "do", "I", "go","Gotta", "get", "outa", "the", "city", ".", "I", "really", "do", "because", "it", "is", "not", "even", "funny", "if", "I", "keep", "talking", "about", "wanting", "to", "go", "hiking", "in", "the", "woods", "."];
