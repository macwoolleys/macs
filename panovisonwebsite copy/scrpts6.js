...
function randomColor() {
  ...
  var boxes = [];
  var words = ["Lockers", "are", "so", "middle", "school", ".", "I", "was", "so", "excited", "to", "get", "my", "first", "locker", ".", "Nostalgic", "memories", "are", "feeling", "my", "head", ".", "I", "loved", "middle", "school", "I", "got", "introduced", "to", "a", "whole", "new", "world", ".", "All", "the", "things", "I've", "experienced", "when", "I", "was", "12", "can", "be", "reflected", "in", "a", "locker", ".", "It's", "kind", "of", "lame", "but", "cool", "how", "flashbacks", "work", "."];
